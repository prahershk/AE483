                     ...
                     const uint32_t tick)
{
    ...
    if (use_observer) {
      ...
      Y_0 = (o_x*(o_x_eq - x0))/sqrt((o_x_eq - x0)*(o_x_eq - x0) + (o_y_eq - y_0)*(o_y_eq - y_0) + (o_z_eq - z0)*(o_z_eq - z0)) + (o_y*(o_y_eq - y_0))/sqrt((o_x_eq - x0)*(o_x_eq - x0) + (o_y_eq - y_0)*(o_y_eq - y_0) + (o_z_eq - z0)*(o_z_eq - z0)) + (o_z*(o_z_eq - z0))/sqrt((o_x_eq - x0)*(o_x_eq - x0) + (o_y_eq - y_0)*(o_y_eq - y_0) + (o_z_eq - z0)*(o_z_eq - z0)) - sqrt((o_x - x0)*(o_x - x0) + (o_y -  y_0)*(o_y - y_0) + (o_z - z0)*(o_z - z0)) + sqrt((o_x_eq - x0)*(o_x_eq - x0) + (o_y_eq -  y_0)*(o_y_eq - y_0) + (o_z_eq - z0)*(o_z_eq - z0));
      Y_1 = (o_x*(o_x_eq - x1))/sqrt((o_x_eq - x1)*(o_x_eq - x1) + (o_y_eq - y_1)*(o_y_eq - y_1) + (o_z_eq - z1)*(o_z_eq - z1)) + (o_y*(o_y_eq - y_1))/sqrt((o_x_eq - x1)*(o_x_eq - x1) + (o_y_eq - y_1)*(o_y_eq - y_1) + (o_z_eq - z1)*(o_z_eq - z1)) + (o_z*(o_z_eq - z1))/sqrt((o_x_eq - x1)*(o_x_eq - x1) + (o_y_eq - y_1)*(o_y_eq - y_1) + (o_z_eq - z1)*(o_z_eq - z1)) - sqrt((o_x - x1)*(o_x - x1) + (o_y -  y_1)*(o_y - y_1) + (o_z - z1)*(o_z - z1)) + sqrt((o_x_eq - x1)*(o_x_eq - x1) + (o_y_eq -  y_1)*(o_y_eq - y_1) + (o_z_eq - z1)*(o_z_eq - z1));
      Y_2 = (o_x*(o_x_eq - x2))/sqrt((o_x_eq - x2)*(o_x_eq - x2) + (o_y_eq - y2)*(o_y_eq - y2) + (o_z_eq - z2)*(o_z_eq - z2)) + (o_y*(o_y_eq - y2))/sqrt((o_x_eq - x2)*(o_x_eq - x2) + (o_y_eq - y2)*(o_y_eq - y2) + (o_z_eq - z2)*(o_z_eq - z2)) + (o_z*(o_z_eq - z2))/sqrt((o_x_eq - x2)*(o_x_eq - x2) + (o_y_eq - y2)*(o_y_eq - y2) + (o_z_eq - z2)*(o_z_eq - z2)) - sqrt((o_x - x2)*(o_x - x2) + (o_y -  y2)*(o_y - y2) + (o_z - z2)*(o_z - z2)) + sqrt((o_x_eq - x2)*(o_x_eq - x2) + (o_y_eq -  y2)*(o_y_eq - y2) + (o_z_eq - z2)*(o_z_eq - z2));
      Y_3 = (o_x*(o_x_eq - x3))/sqrt((o_x_eq - x3)*(o_x_eq - x3) + (o_y_eq - y3)*(o_y_eq - y3) + (o_z_eq - z3)*(o_z_eq - z3)) + (o_y*(o_y_eq - y3))/sqrt((o_x_eq - x3)*(o_x_eq - x3) + (o_y_eq - y3)*(o_y_eq - y3) + (o_z_eq - z3)*(o_z_eq - z3)) + (o_z*(o_z_eq - z3))/sqrt((o_x_eq - x3)*(o_x_eq - x3) + (o_y_eq - y3)*(o_y_eq - y3) + (o_z_eq - z3)*(o_z_eq - z3)) - sqrt((o_x - x3)*(o_x - x3) + (o_y -  y3)*(o_y - y3) + (o_z - z3)*(o_z - z3)) + sqrt((o_x_eq - x3)*(o_x_eq - x3) + (o_y_eq -  y3)*(o_y_eq - y3) + (o_z_eq - z3)*(o_z_eq - z3));
      Y_4 = (o_x*(o_x_eq - x4))/sqrt((o_x_eq - x4)*(o_x_eq - x4) + (o_y_eq - y4)*(o_y_eq - y4) + (o_z_eq - z4)*(o_z_eq - z4)) + (o_y*(o_y_eq - y4))/sqrt((o_x_eq - x4)*(o_x_eq - x4) + (o_y_eq - y4)*(o_y_eq - y4) + (o_z_eq - z4)*(o_z_eq - z4)) + (o_z*(o_z_eq - z4))/sqrt((o_x_eq - x4)*(o_x_eq - x4) + (o_y_eq - y4)*(o_y_eq - y4) + (o_z_eq - z4)*(o_z_eq - z4)) - sqrt((o_x - x4)*(o_x - x4) + (o_y -  y4)*(o_y - y4) + (o_z - z4)*(o_z - z4)) + sqrt((o_x_eq - x4)*(o_x_eq - x4) + (o_y_eq -  y4)*(o_y_eq - y4) + (o_z_eq - z4)*(o_z_eq - z4));
      Y_5 = (o_x*(o_x_eq - x5))/sqrt((o_x_eq - x5)*(o_x_eq - x5) + (o_y_eq - y5)*(o_y_eq - y5) + (o_z_eq - z5)*(o_z_eq - z5)) + (o_y*(o_y_eq - y5))/sqrt((o_x_eq - x5)*(o_x_eq - x5) + (o_y_eq - y5)*(o_y_eq - y5) + (o_z_eq - z5)*(o_z_eq - z5)) + (o_z*(o_z_eq - z5))/sqrt((o_x_eq - x5)*(o_x_eq - x5) + (o_y_eq - y5)*(o_y_eq - y5) + (o_z_eq - z5)*(o_z_eq - z5)) - sqrt((o_x - x5)*(o_x - x5) + (o_y -  y5)*(o_y - y5) + (o_z - z5)*(o_z - z5)) + sqrt((o_x_eq - x5)*(o_x_eq - x5) + (o_y_eq -  y5)*(o_y_eq - y5) + (o_z_eq - z5)*(o_z_eq - z5));
      Y_6 = (o_x*(o_x_eq - x6))/sqrt((o_x_eq - x6)*(o_x_eq - x6) + (o_y_eq - y6)*(o_y_eq - y6) + (o_z_eq - z6)*(o_z_eq - z6)) + (o_y*(o_y_eq - y6))/sqrt((o_x_eq - x6)*(o_x_eq - x6) + (o_y_eq - y6)*(o_y_eq - y6) + (o_z_eq - z6)*(o_z_eq - z6)) + (o_z*(o_z_eq - z6))/sqrt((o_x_eq - x6)*(o_x_eq - x6) + (o_y_eq - y6)*(o_y_eq - y6) + (o_z_eq - z6)*(o_z_eq - z6)) - sqrt((o_x - x6)*(o_x - x6) + (o_y -  y6)*(o_y - y6) + (o_z - z6)*(o_z - z6)) + sqrt((o_x_eq - x6)*(o_x_eq - x6) + (o_y_eq -  y6)*(o_y_eq - y6) + (o_z_eq - z6)*(o_z_eq - z6));
      Y_7 = (o_x*(o_x_eq - x7))/sqrt((o_x_eq - x7)*(o_x_eq - x7) + (o_y_eq - y7)*(o_y_eq - y7) + (o_z_eq - z7)*(o_z_eq - z7)) + (o_y*(o_y_eq - y7))/sqrt((o_x_eq - x7)*(o_x_eq - x7) + (o_y_eq - y7)*(o_y_eq - y7) + (o_z_eq - z7)*(o_z_eq - z7)) + (o_z*(o_z_eq - z7))/sqrt((o_x_eq - x7)*(o_x_eq - x7) + (o_y_eq - y7)*(o_y_eq - y7) + (o_z_eq - z7)*(o_z_eq - z7)) - sqrt((o_x - x7)*(o_x - x7) + (o_y -  y7)*(o_y - y7) + (o_z - z7)*(o_z - z7)) + sqrt((o_x_eq - x7)*(o_x_eq - x7) + (o_y_eq -  y7)*(o_y_eq - y7) + (o_z_eq - z7)*(o_z_eq - z7));
      ...
      phi += 0.0011102988440636*Y_0 + 0.000924017496367406*Y_1 + 1.32718313490127e-5*Y_10 + 0.00111634434284999*Y_2 - 0.00106702791703278*Y_3 - 0.000938737703011303*Y_4 - 0.00062368612223573*Y_5 + 0.00103399380969206*Y_6 - 0.000638144033820692*Y_7 + 1.3183332132583e-7*Y_8 - 0.0206557025088524*Y_9 + w_x;
