                     ...
                     const uint32_t tick)
{
    ...
    if (use_observer) {
      ...
      phi += dt*(0.0011102988440636f*Y_0 + 0.000924017496367406f*Y_1 + 1.32718313490127e-5f*Y_10 + 0.00111634434284999f*Y_2 - 0.00106702791703278f*Y_3 - 0.000938737703011303f*Y_4 - 0.00062368612223573f*Y_5 + 0.00103399380969206f*Y_6 - 0.000638144033820692f*Y_7 + 1.3183332132583e-7f*Y_8 - 0.0206557025088524f*Y_9 + w_x);
